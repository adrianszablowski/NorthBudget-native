...
const actionsheetItemStyle = tva({
  base: "w-full flex-row items-center rounded-sm p-3 hover:bg-primary-50 active:bg-primary-50 data-[checked=true]:bg-primary-50 data-[focus=true]:bg-primary-50 web:data-[focus-visible=true]:bg-primary-50 data-[disabled=true]:opacity-40 data-[disabled=true]:web:pointer-events-auto data-[disabled=true]:web:cursor-not-allowed rounded-md active:rounded-md",
});
